package by.issoft.controller.utils.constants;

public class TestConstants {
    public static final String ADMIN_CINEMA_MAPPING = "/admin/movie-theaters/";
    public static final String PUBLIC_CINEMA_MAPPING = "/movie-theaters/";
    public static final String ADMIN_EVENT_MAPPING = "/admin/events/";
    public static final String PUBLIC_EVENT_MAPPING = "/events/";
